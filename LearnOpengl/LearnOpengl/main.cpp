...
int main()
{
    ...
    Shader ourShader("ShaderCode/Chapter3/8_poscoord/Vertex.vs", "ShaderCode/Chapter3/8_poscoord/Frag.fs");
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
    ...
    std::cout<<"ori:"<<front.x<<","<<front.y<<","<<front.z<<std::endl;
    //cameraFront = glm::normalize(front);
    //此处没必要normalize
    cameraFront = front;
    std::cout<<"normal:"<<front.x<<","<<front.y<<","<<front.z<<std::endl;
}
