...
int main()
{
    ...
    Shader cubeShader("ShaderCode/Chapter4/1_color/Color.vs", "ShaderCode/Chapter4/1_color/Color.fs");
    
    Shader lightCubeShader("ShaderCode/Chapter4/1_color/LightCube.vs", "ShaderCode/Chapter4/1_color/LightCube.fs");
